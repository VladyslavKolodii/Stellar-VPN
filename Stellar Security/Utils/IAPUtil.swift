...
extension IAPUtil: SKPaymentTransactionObserver {
    ...
    func paymentQueueRestoreCompletedTransactionsFinished(_ queue: SKPaymentQueue) {
        for transaction in queue.transactions {
            ...
            UserDefaults.standard.setValue(prodID, forKey: "SUBSCRIBED_ID")
        }
        onBuyProductHandler?(.success(true))
    }
...
extension IAPUtil: SKProductsRequestDelegate {
...
extension IAPUtil.IAPManagerError: LocalizedError {
